            ...
            <div class="row justify-content-center">
                <div class="col-md-8 col-lg-6">
                    <div class="quiz-container">
                        ...
                        <form method="get" action="quizQuestions.jsp">
                            <div class="form-group mb-4">
                                <label for="quizSelect">Sélectionnez un Quiz:</label>
                                <select class="form-control" id="quizSelect" name="quizId" required>
                                    ...
                                    <%
                                            ...
                                            out.println("<div class='alert alert-warning'>Aucun quiz disponible pour le moment.</div>");
                                        }
                                    %>
                                </select>
                            </div>
