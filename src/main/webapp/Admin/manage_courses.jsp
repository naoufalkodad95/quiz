...
<%@ page import="org.example.mindplomv2.model.Course" %>
...
<div class="wrapper">
    ...
    <div class="sidebar" data-background-color="dark">
        <div class="sidebar-logo">
            ...
            <div class="logo-header" data-background-color="dark">
                ...
                <a href="admin_dashboard.jsp" class="logo " alt="navbar brand" class="navbar-brand"  >
    ...
    <div class="main-panel">
        <div class="main-header">
            <div class="main-header-logo">
                ...
                <div class="logo-header" data-background-color="dark">
                    ...
                    <a href="Admin/admin_d" class="logo">
        ...
        <div class="container">
            <div class="container-fluid">
                <div class="card">
                    <div class="d-flex justify-content-around align-items-center pt-3 pb-3 mt-3 mb-3">
                        <h2 class="mb-0">Gérer les Cours</h2>
                    ...
                    <div class="table-responsive">
                        <table class="table table-hover text-center">
                            ...
                            <tr>
                                ...
                                <td>
                                    <div class="course-actions justify-content-end">
                                        <button type="button" class="btn btn-warning btn-sm" data-bs-toggle="modal" data-bs-target="#editCourseModal<%= course.getId() %>">
                                            <i class="fas fa-edit me-1"></i> Modifier
                                        </button>
                                        <button type="button" class="btn btn-danger btn-sm" onclick="confirmDelete(<%= course.getId() %>)">
                            ...
                            <tr>
                                <td colspan="3" class="empty-state">
                                    ...
                                    <p class="mb-0">Aucun cours disponible</p>
                                </td>
                            </tr>
                            <% } %>
                            </tbody>
            ...
            <div class="modal-dialog">
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        <form method="post" action="../Admin/Course/AddCourseServlet">
                            <div class="mb-3">
                                <%--@declare id="coursename"--%><label for="courseName" class="form-label">Nom du Cours</label>
        ...
        <% if (courses != null) {
            for (Course course : courses) { %>
        <div class="modal fade" id="editCourseModal<%= course.getId() %>" tabindex="-1" aria-hidden="true">
            <div class="modal-dialog">
                <div class="modal-content">
                    <div class="modal-header">
                    ...
                    <div class="modal-body">
                        <form method="post" action="../Admin/Course/EditCourseServlet">
                            <input type="hidden" name="id" value="<%= course.getId() %>">
                            <div class="mb-3">
                                <%--@declare id="name"--%><label for="name" class="form-label">Nom du Cours</label>
            ...
            function confirmDelete(courseId) {
                Swal.fire({
                    ...
                    if (result.isConfirmed) {
                        window.location.href = "../Admin/Course/DeleteCourseServlet?id=" + courseId;
                    }
                });
            }
        </script>
